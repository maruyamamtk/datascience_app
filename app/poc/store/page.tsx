...
export default function StorePocPage() {
  return (
    <main className="mx-auto max-w-3xl px-6 py-16">
      <p className="text-sm font-medium tracking-widest text-slate-400 uppercase">Infra · Issue #3</p>
      ...
      <p className="mt-3 mb-10 leading-relaxed text-slate-600">
        ...
        Control（操作）/ Compute（純関数）/ Render（Graph・Math・数値）を疎結合に分離します。
        Math と Graph と数値表示は<strong>同一ストアを購読</strong>するため、 1
